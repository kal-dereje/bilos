...
function Location() {
  return (
    <div id='Location' className='flex-col relative bg-[#1A1814]'>
      <h1 className=' text-slate-300 text-center text-4xl pt-32 mb-0 header-font'>
        Our <span className=' text-Bilos-primary'>Locations</span>{' '}
      </h1>
      <div className='flex m-10 mt-10 mb-24 rounded-2xl '>
        <iframe
          className='w-full h-72'
          src='https://www.google.com/maps/d/u/0/embed?mid=1aWD8hA_Demr6LwUA0l-fwGFw2d8HMxw&ehbc=2E312F'></iframe>
      </div>

      <div className=' flex-col bg-black  flex-wrap h-72 w-full'>
        ...
        <h3 className='m-4 items-center text-center text-font text-Bilos-fourth'>
          © Copyright{' '}
          <span className=' font-extrabold'>Bilo's Pastry</span>. All
          Rights Reserved
        </h3>
      </div>
    </div>
