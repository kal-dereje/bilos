...
function About() {
  return (
    <div id="About" className="bg-emerald-200">
      ...
      <div className="flex flex-col justify-center items-center gap-10 mt-32">
        <h1 className="font-Pacifico text-3xl text-Bilos-third">
          Why choose Our Restaurant
        </h1>
        <p className="font-Kanit font-extralight text-center w-1/3 text-Bilos-third">
...
const Box = ({ number, title, descripton }) => {
  ...
  return (
    <div
      ...
      className="w-11/12 lg:w-1/4 h-1/3 flex flex-col gap-5 justify-around items-left  px-10 py-12 shadow-custom transition-all duration-300 hover:text-white hover:bg-Bilos-primary hover:py-6 bg-green-100"
    >
      <h1
        className={
